...
const fecha_inv= document.getElementById('fecha_inv');
const fecha_enc= document.getElementById('fecha_enc');
...
on(document, 'click','.btnEditar', (e)=>{
    ...
    fecha_inv.value = fechainventarioForm;
    fecha_enc.value = fecha_encargadoForm;
    ...
    if(opcion=='editar'){
        fetch(url+idForm, {
            ...
            body: JSON.stringify({
                ...
                fecha_inv: fecha_inv.value,
                fecha_enc: fecha_enc.value,
