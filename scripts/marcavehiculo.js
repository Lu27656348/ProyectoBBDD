...
on(document, 'click','.btnEditar', (e)=>{
    ...
    const cantidadpForm = fila.children[3].innerHTML;
    const refrigeranteForm = fila.children[4].innerHTML;
    ...
    console.log('Valores');
    console.log(nombremarca.value);
    console.log(aceitecaja.value);
    console.log(descripcion.value);
    console.log(cantidadp.value);
    console.log(refrigerante.value);
    console.log(octanaje.value);
